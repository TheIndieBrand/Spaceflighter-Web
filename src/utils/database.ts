...
const pool = new Pool({
    user: import.meta.env.PG_USER || "postgres",
    host: import.meta.env.PG_HOST || "127.0.0.1",
    database: import.meta.env.PG_DATABASE || "my_database",
    password: import.meta.env.PG_PASSWORD || "password",
    port: parseInt(import.meta.env.PG_PORT || "5432"),
});
...
class Database {
    ...
    public static getInstance(tableName: 'planets' | 'companies' | 'solarsystems' | 'profiles' | 'galaxies'): Database {
